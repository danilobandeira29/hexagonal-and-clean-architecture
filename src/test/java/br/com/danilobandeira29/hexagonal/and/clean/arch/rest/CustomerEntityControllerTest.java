package br.com.danilobandeira29.hexagonal.and.clean.arch.rest;

import br.com.danilobandeira29.hexagonal.and.clean.arch.application.usecases.customer.GetCustomerByIdUseCase;
import br.com.danilobandeira29.hexagonal.and.clean.arch.infrastructure.dtos.NewCustomerDTO;
...
@SpringBootTest(classes = br.com.danilobandeira29.hexagonal.and.clean.arch.infrastructure.Main.class)
public class CustomerEntityControllerTest {
    ...
    public void testCreateWithDuplicatedEmailShouldFail() throws Exception {
        ...
        var customer = new NewCustomerDTO("John Doe", "123.456.189-01","john.doe@gmail.com");
